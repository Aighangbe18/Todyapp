...
const Onboarding1Screen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        source={require("../../src/assets/images/Frame 215.png")} // Use your image path here
        style={styles.topImage}
      />

      <View style={styles.imageContainer}>
        <Image
          source={require("../../src/assets/images/phone3.png")}
          style={styles.image}
        />
      </View>
      ...
      <Image
        source={require("../../src/assets/images/Frame 216.png")} // Use your image path here
      ...
      <View style={styles.footerContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/Onboarding2Screen")} // Navigate to the next onboarding screen
        >
